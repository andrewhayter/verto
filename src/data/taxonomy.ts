...
export const pillars: Pillar[] = [
    ...
    clusters: [
      {
        ...
        problems: ['cant-lose-weight', 'blood-sugar-control'],
      ...
      },
      {
        ...
        blurb: 'Mobility and chronic-pain support without the runaround.',
        problems: ['joint-pain-relief'],
        categories: ['health-wellness'],
      },
    ],
  },
  {
    ...
    clusters: [
      {
        slug: 'loans',
        name: 'Loans & Bad Credit',
        blurb: 'Personal loans, emergency cash, and lenders for thin credit.',
        problems: ['need-personal-loan'],
