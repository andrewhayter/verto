...
export const problems: Problem[] = [
  {
    ...
    topOfferIds: [32072, 31644, 31973, 28778, 31359, 30587, 32122, 29798],
    faqs: [
      {
  ...
  // --- New problem pages added 2026-06-13 batch 2 ---
  {
    slug: 'mens-suits-online',
    headline: 'Your Off-the-Rack Suit Doesn\'t Fit — Here\'s Why, and the Made-to-Measure Alternative at the Same Price',
    subheadline: 'Custom tailored suits built to your exact measurements — delivered without the in-store appointment or the $2,000 bespoke price tag',
    hook: 'I spent 8 years buying suits off the rack. They never fit my shoulders and my chest at the same time. Then I discovered made-to-measure.',
    description: 'Off-the-rack suits are built for a statistical average that fits almost no one. Shoulders too wide, chest too tight, sleeves never the right length. Made-to-measure suits are cut to your actual measurements — but the traditional version requires a tailor, three fittings, and $1,500+. Kahlon delivers custom-tailored suits built from your measurements online, shipped direct, for a fraction of the custom price.',
    emoji: '',
    gradient: 'linear-gradient(135deg, #1e293b, #334155)',
    category: 'shopping-ecommerce',
    audience: 'Men 25–55 who need a well-fitting suit for work, weddings, or events',
    topOfferIds: [29358],
    faqs: [
      { q: 'How does online made-to-measure work?', a: 'You enter your measurements using a guided measurement guide (chest, waist, hips, inseam, sleeve length, neck). The suit is then cut and sewn to those specifications before shipping. No store visit required.' },
      { q: 'What if the fit isn\'t right?', a: 'Kahlon includes alterations support. If something doesn\'t fit correctly after following the measurement guide, they work with you to resolve it. The risk of a bad fit is lower than most people expect — the measurement process is well-documented.' },
      { q: 'How long does delivery take?', a: 'Typically 3–4 weeks from order to delivery. The suit is made to order, not pulled from inventory.' },
      { q: 'What\'s the price range?', a: 'Made-to-measure suits from Kahlon start under $500 — comparable to a mid-range off-the-rack suit from a department store, but built to your body.' },
    ],
    trustStats: [
      { stat: '3–4 wks', label: 'Delivery from order to door' },
      { stat: '$499+', label: 'Starting price — comparable to mid-range off-rack' },
      { stat: '$187.50', label: 'Commission per qualified lead' },
    ],
    seoTitle: 'Made-to-Measure Suits Online 2026 — Custom Fit Without the Tailor Price | Verto',
    seoDescription: 'Off-the-rack suits never fit because they\'re built for a statistical average. Kahlon makes suits to your measurements and ships them for under $500.',
    facebookHook: 'I spent 8 years in suits that didn\'t fit my shoulders and chest at the same time. Here\'s what changed that.',
  },
  {
    slug: 'bad-credit-loans-canada',
    headline: 'Canadian Banks Keep Saying No — Here\'s the Lender Network Built for Subprime Borrowers',
    subheadline: 'No hard credit check to get matched — lenders who work with scores below 600, income-based approval',
    hook: 'I was rejected by TD, Scotiabank, and a credit union in the same week. My score was 571. I thought I was out of options. I wasn\'t.',
    description: 'Canada\'s major banks require credit scores of 650+ for most personal loans — leaving millions of Canadians with no legitimate options when they need emergency funds. Credit Resources CA connects subprime borrowers with a network of alternative lenders who evaluate income, employment, and debt-to-income ratio alongside credit history.',
    emoji: '',
    gradient: 'linear-gradient(135deg, #dc2626, #7f1d1d)',
    category: 'financial',
    audience: 'Canadians with credit scores under 620 who need personal loans',
    topOfferIds: [31464, 31093],
    faqs: [
      { q: 'What credit score do I need?', a: 'Credit Resources CA works with borrowers down to 500 credit scores. Lenders in the network evaluate income and employment stability alongside credit history — a steady paycheck can offset a low score.' },
      { q: 'Does applying affect my credit score?', a: 'The initial matching process uses a soft pull only, which does not affect your credit score. A hard pull may occur when you proceed with a specific lender, but only after you\'ve reviewed their offer.' },
      { q: 'How fast can I get funds?', a: 'Most lenders in the network can deposit funds within 1–3 business days of approval. Some offer same-day funding for qualifying borrowers.' },
      { q: 'What amounts are available?', a: 'Loan amounts typically range from $500–$15,000 for subprime borrowers. Amounts depend on income verification and lender assessment.' },
    ],
    trustStats: [
      { stat: '500+', label: 'Minimum credit score for network lenders' },
      { stat: '1–3 days', label: 'Typical funding timeline after approval' },
      { stat: '$1.97', label: 'Network EPC — proven conversion rate' },
    ],
    seoTitle: 'Bad Credit Loans Canada 2026 — Lenders Who Work With Scores Under 620 | Verto',
    seoDescription: 'Rejected by Canadian banks? Credit Resources connects you with alternative lenders who evaluate income and employment — not just your credit score.',
    facebookHook: 'Three Canadian bank rejections in one week with a 571 credit score. Here\'s the platform that found me an alternative.',
  },
  {
    slug: 'mortgage-canada',
    headline: 'The Big Canadian Banks Are Charging You More Than They Have To — Here\'s the Online Lender With Better Rates',
    subheadline: 'Pine.ca consistently beats big bank mortgage rates — fully online, no broker, no hidden fees',
    hook: 'My bank quoted me 5.94% for a 5-year fixed mortgage. Pine quoted me 5.29%. On a $650,000 mortgage, that\'s $32,000 over the term. I didn\'t know online mortgage lenders existed.',
    description: 'Canadian mortgage rates at the big banks include a spread that covers branches, advisors, and overhead. Pine is a digital mortgage lender with significantly lower overhead — and passes that saving to borrowers. The fully online process takes 20 minutes, there are no broker fees, and rates are consistently below TD, RBC, and Scotiabank\'s posted rates.',
    emoji: '',
    gradient: 'linear-gradient(135deg, #dc2626, #991b1b)',
    category: 'financial',
    audience: 'Canadians buying a home or renewing a mortgage in 2026',
    topOfferIds: [30595],
    faqs: [
      { q: 'Is Pine.ca a licensed mortgage lender?', a: 'Yes. Pine is a federally regulated mortgage lender licensed to operate across Canada. They\'re not a broker — they fund mortgages directly.' },
      { q: 'How much can I save vs. a big bank?', a: 'The rate gap between Pine and major bank posted rates typically ranges from 0.4–0.8%. On a $600,000 mortgage over a 5-year term, that\'s $12,000–$24,000 in interest savings.' },
      { q: 'Can I use Pine for a renewal?', a: 'Yes. Pine handles both new purchases and renewals. Many of their customers are existing homeowners who switch at renewal to avoid their bank\'s renewal rate.' },
      { q: 'How long does the application take?', a: 'The online application takes 15–20 minutes. Pine typically provides a rate confirmation within 24 hours and can close on standard timelines.' },
    ],
    trustStats: [
      { stat: '0.4–0.8%', label: 'Typical rate advantage over big banks' },
      { stat: '$32K+', label: 'Potential savings on a $650K mortgage' },
      { stat: '$0', label: 'Broker fees charged by Pine.ca' },
    ],
    seoTitle: 'Best Mortgage Rates Canada 2026 — Pine.ca vs the Big Banks | Verto',
    seoDescription: 'Canadian banks charge more than they have to. Pine.ca offers rates 0.4–0.8% below posted bank rates with a 20-minute online application and no broker fees.',
    facebookHook: 'My bank quoted 5.94%. Pine quoted 5.29%. On my mortgage, that\'s $32,000. I had no idea online mortgage lenders were this much cheaper.',
  },
  {
    slug: 'power-backup',
    headline: 'The Next Power Outage Could Last Days — Here\'s the Silent Solar Generator That Runs Your Essentials',
    subheadline: '2,500W output, solar rechargeable, no gas — keeps your fridge, medical devices, and lights running during any blackout',
    hook: 'We lost power for 4 days during an ice storm last winter. No heat. No fridge. No way to charge phones. I will never be unprepared again.',
    description: 'Grid failures are increasing in frequency and duration. Gas generators are loud, produce carbon monoxide, and require fuel storage. The 4Patriots Patriot Power 2500X is a solar-charged portable power station with 2,500W continuous output — enough to run a full-size refrigerator, CPAP machine, phone chargers, and lights simultaneously. Silent, safe indoors, and recharges from solar panels or the grid.',
    emoji: '',
    gradient: 'linear-gradient(135deg, #f59e0b, #78350f)',
    category: 'shopping-ecommerce',
    audience: 'Homeowners 35–70 in regions with weather events, aging grid infrastructure, or rural power instability',
    topOfferIds: [31558],
    faqs: [
      { q: 'What can a 2,500W generator actually run?', a: 'A 2,500W output can simultaneously run a full-size refrigerator (150W), a CPAP machine (30–60W), LED lights (10W each), and multiple phone/laptop chargers. It cannot run a central AC unit or electric range — those require 5,000W+.' },
      { q: 'How long does the battery last?', a: 'Runtime depends on load. Running a refrigerator alone: approximately 12–16 hours. Running lights and device charging only: 24–48+ hours. The solar panels can recharge the unit while it\'s in use.' },
      { q: 'Is it safe to use indoors?', a: 'Yes — unlike gas generators, the 4Patriots unit produces zero emissions and is completely safe indoors. Gas generators should never be run inside a home.' },
      { q: 'How fast does it recharge from solar?', a: 'With the 4Patriots solar panels in direct sun, the unit recharges in 6–8 hours. It can also be recharged from a standard wall outlet in 4–5 hours.' },
    ],
    trustStats: [
      { stat: '2,500W', label: 'Continuous output — runs fridge + devices' },
      { stat: '0 fumes', label: 'Safe indoors — no carbon monoxide' },
      { stat: '4x', label: 'Increase in multi-day outages since 2010' },
    ],
    seoTitle: 'Best Home Backup Power 2026 — Solar Generator for Blackouts | Verto',
    seoDescription: 'Gas generators produce fumes and need fuel. The 4Patriots 2500X solar generator runs your fridge, CPAP, and devices during blackouts — silently, indoors, for days.',
    facebookHook: 'We lost power for 4 days last winter. No heat, no fridge, no phone charging. Here\'s what I bought after that to make sure it never happens again.',
  },
  {
    slug: 'concealed-carry-permit',
    headline: 'How to Get Your Concealed Carry Permit — State Requirements, Online Courses, and What to Expect',
    subheadline: 'State-approved online CCW training you can complete in one sitting — no range visit required for the course portion',
    hook: 'I wanted to carry legally. I didn\'t know where to start. The process was simpler than I expected once I found the right course.',
    description: 'Concealed carry permits require state-specific training that varies by jurisdiction — from a 4-hour online course to a full range qualification day. Country Wide Carry offers state-approved online CCW training courses that fulfill the classroom requirement in most states. The course covers legal use of force, safe storage, and concealed carry best practices. Range qualification (where required by your state) is a separate step completed locally.',
    emoji: '',
    gradient: 'linear-gradient(135deg, #374151, #111827)',
    category: 'legal-services',
    audience: 'Adults 21+ seeking to legally carry concealed in states with CCW programs',
    topOfferIds: [24547],
    faqs: [
      { q: 'Is this course accepted in my state?', a: 'Country Wide Carry\'s courses are accepted in the states where they operate. The course page confirms which states are covered. Most states that allow online classroom training accept Country Wide Carry\'s curriculum.' },
      { q: 'Do I need range time for a CCW permit?', a: 'It depends on your state. Some states require a live-fire range component in addition to the classroom portion. Country Wide Carry\'s online course fulfills the classroom requirement — check your state\'s specific requirements for the range component.' },
      { q: 'How long does the permit process take after the course?', a: 'The timeline varies by state — from 2 weeks to 90 days. Most states process applications within 30–60 days. Some states (Arizona, Alaska, etc.) have constitutional carry and no permit is required.' },
      { q: 'What ID and background check is required?', a: 'You\'ll submit your course completion certificate to your county sheriff or state police with a standard background check form. The process varies by state but is straightforward once you have the course certificate.' },
    ],
    trustStats: [
      { stat: '22M+', label: 'Active CCW permit holders in the US' },
      { stat: '1 sitting', label: 'Complete the online course in one session' },
      { stat: '$85', label: 'Course price — no upsells required' },
    ],
    seoTitle: 'How to Get Your Concealed Carry Permit Online 2026 — State by State Guide | Verto',
    seoDescription: 'State-approved online CCW training courses you can complete in one sitting. Country Wide Carry covers the classroom requirement in most US states.',
    facebookHook: 'I wanted to legally carry. I didn\'t know where to start. Here\'s the online course that got me through the classroom requirement in one afternoon.',
  },
  {
    slug: 'high-yield-savings',
    headline: 'Your Savings Account Is Paying 0.01% APY — Here\'s the Account Paying 3.80%',
    subheadline: 'Online banks with no overhead pass the interest savings to you — up to 10x what your current bank pays',
    hook: 'I had $18,000 in savings earning $1.80/year at my bank. After switching, I earned $684 in the first year. Same money. Zero extra effort.',
    description: 'Traditional bank savings accounts pay 0.01–0.46% APY because branch overhead absorbs the margin. Online banks like SoFi operate without that overhead and consistently pay 10x the national average. SoFi currently offers 3.80% APY on savings with no monthly fees and no minimum balance. Current offers checking with early direct deposit and no overdraft fees. Both accounts take under 5 minutes to open.',
    emoji: '',
    gradient: 'linear-gradient(135deg, #059669, #064e3b)',
    category: 'financial',
    audience: 'Adults 22–55 with savings sitting in traditional bank accounts earning under 1% APY',
    topOfferIds: [32118, 28412],
    faqs: [
      { q: 'Is SoFi FDIC insured?', a: 'Yes. SoFi Bank deposits are FDIC insured up to $250,000 per depositor, per ownership category. The same federal protection as any traditional bank.' },
      { q: 'Will the 3.80% APY stay that high?', a: 'High-yield savings rates fluctuate with the federal funds rate. SoFi\'s rate is consistently among the highest available and has been well above traditional banks for years. The current rate is verified as of the publication date — check the SoFi site for the current rate.' },
      { q: 'Is there a minimum balance?', a: 'No. SoFi charges no monthly fees and requires no minimum balance. You earn the full APY on your entire balance from day one.' },
      { q: 'How easy is it to access my money?', a: 'SoFi is connected to the ACH network and supports instant transfers to/from most major banks. Transfers to external accounts typically take 1–2 business days. There are no withdrawal limits on savings.' },
    ],
    trustStats: [
      { stat: '3.80% APY', label: 'SoFi current savings rate' },
      { stat: '0.01%', label: 'What most traditional bank savings accounts pay' },
      { stat: '$684', label: 'First-year earnings on $18K at 3.80% APY' },
    ],
    seoTitle: 'Best High-Yield Savings Accounts 2026 — SoFi vs Current vs Your Bank | Verto',
    seoDescription: 'Traditional bank savings accounts pay 0.01%. Online banks pay 3.80%+. Same FDIC protection. Here\'s what SoFi and Current offer and how to open an account in 5 minutes.',
    facebookHook: 'I had $18,000 in savings earning $1.80 a year at my bank. After switching, I earned $684 in 12 months. Same money. 5-minute account opening.',
  },
  {
    slug: 'life-insurance-online',
    headline: 'Life Insurance in 5 Minutes — No Medical Exam, No Agent, No Waiting Room',
    subheadline: 'Most Americans are either uninsured or paying $200+/month for coverage they could get for $30. Here\'s what term life actually costs.',
    hook: 'I assumed life insurance was complicated. I thought I\'d need a physical, a broker, and weeks to sort out. I had $1M in coverage confirmed in 8 minutes.',
    description: 'Most people avoid life insurance because the traditional process is painful — a broker appointment, a medical exam, a 6-week wait. Online term life insurers like Ladder have changed that. Instant-decision coverage based on health questionnaire data (no exam for most applicants), same-day confirmation, and pricing that\'s often 40–60% less than what employers offer through group plans.',
    emoji: '',
    gradient: 'linear-gradient(135deg, #0f172a, #1e3a5f)',
    category: 'financial',
    audience: 'Adults 25–55 with dependents who are uninsured or underinsured',
    topOfferIds: [28771],
    faqs: [
      { q: 'What is term life insurance?', a: 'Term life pays a lump sum to your beneficiaries if you die during the policy term (usually 10, 20, or 30 years). It has no cash value — it\'s pure protection. A healthy 35-year-old can get $500,000 of 20-year coverage for $20–$25/month.' },
      { q: 'Do I need a medical exam?', a: 'Most Ladder applicants under 60 with no major health conditions are approved instantly based on health questions alone. A medical exam may be required for larger coverage amounts or applicants with complex health histories.' },
      { q: 'How much coverage do I need?', a: 'A common rule: 10–12x your annual income. For a $70,000/year earner, that\'s $700,000–$840,000 in coverage. The goal is replacing your income for your dependents over the years they\'d need it most.' },
      { q: 'Can I cancel if my situation changes?', a: 'Yes. Ladder allows you to adjust or cancel your coverage at any time. This flexibility is one of their differentiators — you can "ladder down" your coverage as your mortgage shrinks and your kids grow up.' },
    ],
    trustStats: [
      { stat: '5 min', label: 'Typical time to approved coverage on Ladder' },
      { stat: '$20–25/mo', label: 'Typical cost for $500K coverage at age 35' },
      { stat: '43%', label: 'Americans with no or insufficient life insurance' },
    ],
    seoTitle: 'Life Insurance Online 2026 — $500K Coverage Without a Medical Exam | Verto',
    seoDescription: 'Term life insurance doesn\'t require a broker appointment or a medical exam anymore. Ladder approves most applicants in under 5 minutes with instant online coverage.',
    facebookHook: 'I assumed life insurance meant a broker appointment, a blood draw, and six weeks of waiting. I got $1M in coverage confirmed in 8 minutes online. Here\'s how.',
  },
